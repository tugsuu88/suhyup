...
<!--
	...
	function goReg(){
		...
		f.action = "../minwon/taxfree_list_my.jsp";	
	...
	function goEdit(){
		...
		if (confirm("수정하시겠습니까?")) {
			...
			f.action = "../minwon/taxfree_edit_my.jsp";	
	...
	function goDel(){ 
		...
		if (confirm("삭제하시겠습니까?")) {
			...
			f.action = "../minwon/taxfree_del_proc_my.jsp";	
	...
	function goCode(){
		...
		if (confirm("철회하시겠습니까?")) {
			...
			f.action = "../minwon/taxfree_code_proc_my.jsp";	
				 ...
				 <table width="370" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" class="button">
                    ...
                    <tr> 
					  ...
					  <a href="javascript:goEdit();"><img src="../pub_img/btT01Modify.gif" /></a>

					  <a href="javascript:goDel();"><img src="../pub_img/btT01Delete.gif" /></a>
