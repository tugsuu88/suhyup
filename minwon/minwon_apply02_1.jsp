...
<!--
	...
	function GoReg() {
			...
			********************************************위너다임 작업 끝 2008.03.13******************************************************/
			...
			pbform.action = "minwon_proc_1.jsp";
			...
			<div class="pdl20 pdr30">
				...
				<div class="mgl15">
					<div class="box_upperNotify mgb40">
						<ul>
						<li>
							<strong>수협중앙회에 민원을 제출해 주시면 최대한 친절하고 상세하게 답변을 드리겠습니다.</strong><br />
							민원사항에 대한 조회는 ‘민원처리결과조회’ 페이지에서 확인하시면 됩니다.
						</li>
						</ul>
					</div>
					...
					<tr>
						<th scope="row">제       목</th>
						<td>
							<input type="text" name="sh_title" class="text w100p" title="제목" />
						</td>
					</tr>
					<tr>
						<th scope="row">내       용</th>
						<td>
							<textarea name="contents" cols="1" rows="1" class="w100p" title="내용"></textarea>
						</td>
					</tr>
					<tr>
						<th scope="row">파       일</th>
						<td>
							...
							<li>※ 문서파일 : hwp, ppt, xls, gul, doc, txt, pdf 파일만 첨부 가능합니다.</li>
