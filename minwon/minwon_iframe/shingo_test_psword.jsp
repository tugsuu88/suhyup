...
<form name="pbform" method="post" action="shingo_test_list.jsp">
    ...
    <td id="content"><!-- 비밀번호 입력 창 시작 -->
        ...
        <table cellspacing="0" style="border:2px solid #E9E9E9; margin:0 0 0 0px; width:716px;">
          ...
          <tr>
            ...
            <td align="center"><table width="96%" border="0" cellspacing="0" cellpadding="0" height="45">
                ...
                <tr>
                  ...
                  <td align="center" bgcolor="F9F9F9"><font color="323232"><b>이름</b></font>
                      ...
                      <input type="text" class="typeText input_txt" name="name" value="" />                  </td>
            ...
            <td align="center"><table width="96%" border="0" cellspacing="0" cellpadding="0" height="45">
                ...
                <tr>
                  ...
                  <td align="center" bgcolor="F9F9F9"><font color="323232"><b>비밀번호</b></font>
                    ...
                    <a href="javascript:;" onclick="MM_openBrWindow('shingo_find_psword.jsp','','width=360,height=260')"><img src="../pub_img/btminwon_searchpass.gif" width="85" height="20" align="absmiddle" border="0" title="비밀번호찾기버튼" /></a> </td>
          ...
          <tr>
            ...
            <td align="center"><table cellspacing="0" style="width:745px; margin-top:10px;">


                <tr>


                  <td align="center" height="50"><!-- a href="join_step03.jsp" -->
