...
<!--
	...
	function GoReg(mid){
		...
		f.action = "taxfree_edit_proc.jsp";	
    ...
    <td id="content"><!-- 민원신청 입력 창 시작 -->
        ...
        <table cellspacing="0" class="writeTable">
          ...
          <tr>
            ...
            <td><input type="text"  name="sh_email_1" onblur="checkInput(this)" value="<%=sh_email_1%>" class="typeText input_txt"/>
          ...
          <tr>
            ...
            <td><input type="text" maxlength="3" name="sh_tel_1" value="<%=sh_tel_1%>" class="typeText input_mini" />
                ...
                <input type="text" maxlength="4" name="sh_tel_3" value="<%=sh_tel_3%>" class="typeText input_mini" />            </td>
          ...
          <tr>
            ...
            <td><input type="text" size="4" name="sh_post_1" value="<%=sh_post_1%>" readonly="readonly" class="typeText input_mini" />


                <span class="sp_txt">-</span>


                <input type="text" size="4" name="sh_post_2" value="<%=sh_post_2%>" readonly="readonly" class="typeText input_mini" />


                <a href="javascript:ZipSearch();"><img src="../pub_img/mb_bt_addr.gif" title="주소찾기" /></a> <br />


                <input type="text" name="sh_address_1" value="<%=addr%>" class="typeText input_addr_01"/>


              <br />


                <input type="text" name="sh_address_2" value="<%=addr2%>" class="typeText input_addr_02" />            </td>
          ...
          <tr>
            ...
            <td><input type="text" name="subject" value="<%=subject%>" class="typeText input_addr_01" />            </td>
          ...
          <tr>
            ...
            <td><textarea name="content" value="" cols="25" rows="14" class="typeText content" wrap="virtual"><%=content%></textarea>            </td>
...
<table cellspacing="0" style="width:745px; margin-top:20px;">
  ...
  <tr>
    ...
    <td align="center" height="25"><!-- a href="join_step03.jsp" -->
      ...
      <a href="javascript:GoReg('<%=sh_mid%>');"> <img src="../pub_img/btT01Confirm.gif" title="확인" /></a> <a href="javascript:GoCan('<%=sh_mid%>');"> <img src="../pub_img/btT01Cancle.gif" title="취소" /></a> </td>
