...
<form name="pbform" method="post" action="taxfree_proc.jsp">
...
<table cellpadding="0" cellspacing="0" border="0">
  ...
  <tr>
    ...
    <td id="navigator"><a href="/">Home</a> &gt; <a href="minwon_test1.jsp">전자민원</a> &gt; 면세유루부정유통신고</td>
    ...
    <td id="content"><!-- 민원신청 입력 창 시작 -->
        ...
        <table cellspacing="0" class="writeTable">
          ...
          <tr>
            ...
            <td><input type="text" class="typeText" name="name" value="<%=name%>" />
          ...
          <tr>
            ...
            <td><input type="text" maxlength="3" name="sh_tel_1" onkeyup="return autoTab(this, 3, event);" value="" class="typeText input_mini" />

                <span class="sp_txt">-</span>

                <input type="text" maxlength="4" name="sh_tel_2" onkeyup="return autoTab(this, 4, event);" value="" class="typeText input_mini" />

                <span class="sp_txt">-</span>

                <input type="text" maxlength="4" name="sh_tel_3" onkeyup="return autoTab(this, 4, event);" value="" class="typeText input_mini" />
          ...
          <tr>
            ...
            <td><input type="text" maxlength="3" name="sh_tele_1" onkeyup="return autoTab(this, 3, event);" value="" class="typeText input_mini" />

                <span class="sp_txt">-</span>

                <input type="text" maxlength="4" name="sh_tele_2" onkeyup="return autoTab(this, 4, event);" value="" class="typeText input_mini" />

                <span class="sp_txt">-</span>

                <input type="text" maxlength="4" name="sh_tele_3" onkeyup="return autoTab(this, 4, event);" value="" class="typeText input_mini" />
          ...
          <tr>
            ...
            <td><input type="text" name="title" value="" class="typeText input_addr_01" />
          ...
          <tr>
            ...
            <td><textarea name="contents" value="" cols="25" rows="14" class="typeText content" wrap="virtual"></textarea>
          ...
          <tr>
            ...
            <td><input type="password" name="psword" value="" class="typeText input_txt" />
                ...
                <span class="sp_txt">(게시물을 수정 또는 삭제할 때 필요합니다.)</span> </td>
...
<table cellspacing="0" style="width:745px; margin-top:20px;">
  ...
  <tr>
    ...
    <td align="center" height="25"><!-- a href="join_step03.jsp" -->
      ...
      <a href="javascript:GoReg();"> <img src="../pub_img/btT01Confirm.gif" title="확인" /></a> <a href="javascript:GoCan();"> <img src="../pub_img/btT01Cancle.gif" title="취소" /></a> </td>
