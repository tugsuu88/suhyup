...
<form name="pbform" method="post" action="corruption_list.jsp">
				...
				<div class="mgl15">
					...
					<table class="write01" summary="">
						...
						<tr>
							...
							<td>
								<input type="password" class="text" style="width:138px;" title="비밀번호" id="pass" name="passwd" value="" />
								<a class="btn_blue_s01" href="#" onClick="MM_openBrWindow('corruption_find_psword.jsp','','width=360,height=260')"><span>비밀번호 찾기</span></a>
							</td>
						</tr>
					</table>
