...
<%
	...
	try {
		...
		String path = application.getRealPath("/upload/minwon"); //폴더 얻기
		...
		String TableName = " sh_minwon ";
	   	...
	   	String SelectCondition = " sh_fileno, mid, fname";


		String WhereCondition  = " where mid =  " + Integer.parseInt(mid) + " and sh_fileno = " + Integer.parseInt(file_no);
		...
		*/
		...
		out.println("../minwon/download1.jsp : " + e.getMessage());
