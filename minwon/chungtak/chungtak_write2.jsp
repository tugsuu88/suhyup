...
<!--/********************************************위너다임 작업 끝 2008.03.13******************************************************/-->
	...
	function GoReg() {
		...
		//신고자 정보
		if (d.sg_name.value.length == 0) {alert("정상정인 경로가 아닙니다."); d.sg_name.focus(); return;}
		...
		if (d.sg_zip1.value.length == 0) {alert("우편번호가 입력되지 않았습니다."); d.sg_zip1.focus(); return;}
		if (d.sg_zip2.value.length == 0) {alert("우편번호가 입력되지 않았습니다."); d.sg_zip2.focus(); return;}
		
		if (d.sg_addr1.value.length == 0) {alert("주소가 입력되지 않았습니다."); d.sg_addr1.focus(); return;}
		if (d.sg_addr2.value.length == 0) {alert("상세주소가 입력되지 않았습니다."); d.sg_addr2.focus(); return;}
		...
		//피 신고자 (필수)
		if (d.ct_name.value.length == 0) {alert("이름이 입력되지 않았습니다."); d.ct_name.focus(); return;}
		
		if (d.ct_zip1.value.length == 0) {alert("우편번호가 입력되지 않았습니다."); d.ct_zip1.focus(); return;}
		if (d.ct_zip2.value.length == 0) {alert("우편번호가 입력되지 않았습니다."); d.ct_zip2.focus(); return;}
		
		if (d.ct_addr1.value.length == 0) {alert("주소가 입력되지 않았습니다."); d.ct_addr1.focus(); return;}
		if (d.ct_addr2.value.length == 0) {alert("상세주소가 입력되지 않았습니다."); d.ct_addr2.focus(); return;}
		
		
		//법 위반행위 내용
		if (d.ct_date.value.length == 0) {alert("일시가 입력되지 않았습니다."); d.ct_date.focus(); return;}
		if (d.ct_place.value.length == 0) {alert("장소가 입력되지 않았습니다."); d.ct_place.focus(); return;}
			...
			<div class="mgl15">
				<table class="write mgb25" summary="신고형식 선택">
					...
					<tr>
						...
						<td style="height:auto;">
							<input type="radio" name="register" class="radio mgr5 mgl10" id="register01" onclick="goView(1);" /><label for="register01">자진신고용</label>
							<input type="radio" name="register" class="radio mgr5 mgl40" id="register02" checked onclick="goView(2);" /><label for="register02">제3자신고용</label>
						</td>
					</tr>
					</tbody>
				</table>
				...
				<table class="write mgb25" summary="성명, 직업(소속), 연락처, 주소, 비밀번호 입력 테이블">
					...
					<tr>
						...
						<td>
								<input type="text" class="text" name="sg_name" value="<%=name%>" style="width:198px;" title="성명" readonly="readonly"/>
						</td>
					</tr>
					<tr>
						<th scope="row"><span class="txt_request">*</span>직업(소속)</th>
						<td>
							<input type="text" class="text" name="sg_job" style="width:198px;" title="직업(소속)" maxlength="15"/>
						</td>
					</tr>
					<tr>
						<th scope="row"><span class="txt_request">*</span>연락처</th>
						<td>
							<input type="text" class="text" name="sg_tel1" style="width:68px;" title="연락처 첫번째자리" maxlength="3"/><span class="txt_dash vAlignM">-</span>
							<input type="text" class="text" name="sg_tel2" style="width:68px;" title="연락처 중간자리" maxlength="4"/><span class="txt_dash vAlignM">-</span>
							<input type="text"  class="text" name="sg_tel3" style="width:68px;" title="연락처 마지막 자리" maxlength="4"/>
						</td>
					</tr>
					<tr>
						<th scope="row"><span class="txt_request">*</span>주소</th>
						<td>
							<input type="text" class="text" style="width:88px;" name="sg_zip1" title="우편번호" maxlength="3" readonly="readonly" />
							<span class="txt_dash vAlignM">-</span>
							<input type="text" class="text" style="width:88px;" name="sg_zip2" title="우편번호 뒷자리" maxlength="3" readonly="readonly" />
							<a href="javascript:ZipSearch('1');" class="btn_blue_s01 mgl10" title="새창열림"><span>주소찾기</span></a><br />
					...
					<tr>
						...
						<td>
							<input type="password" name="sg_pass" value="" class="text" style="width:198px;" title="비밀번호" maxlength="6"/><p class="displayInB mgl5">비밀번호는 4자리 이상 6자리 이하로 작성하여주세요.</p>
						</td>
					</tr>
					</tbody>
				</table>
				...
				<!-- 신고대상 필수 -->
				<h4 class="title_dot_blue">피신고자(신고대상 필수)</h4>
				<table class="write mgb25" summary="성명, 직업(소속), 연락처, 주소, 법인,단체등의 경우 명칭, 소재지, 대표자성명 입력 테이블">
					...
					<tr>
						<th scope="row">연락처</th>
						<td>
							<input type="text" class="text" style="width:68px;" name="ct_tel1" title="연락처 첫번째자리" maxlength="3"/><span class="txt_dash vAlignM">-</span>
							<input type="text" class="text" style="width:68px;" name="ct_tel2" title="연락처 중간자리" maxlength="4"/><span class="txt_dash vAlignM">-</span>
							<input type="text" class="text" style="width:68px;" name="ct_tel3" title="연락처 마지막 자리" maxlength="4"/>
						</td>
					</tr>
					<tr>
						<th scope="row"><span class="txt_request">*</span>주소</th>
						<td>
							<input type="text" class="text" style="width:88px;" name="ct_zip1" title="우편번호" maxlength="3" readonly="readonly"/>
							<span class="txt_dash vAlignM">-</span>
							<input type="text" class="text" style="width:88px;" name="ct_zip2" title="우편번호 뒷자리" maxlength="3" readonly="readonly" />
								<a href="javascript:ZipSearch('2');" class="btn_blue_s01 mgl10" title="새창열림"><span>주소찾기</span></a><br />
							<input type="text" class="text mgt10 mgb10" name="ct_addr1" style="width:508px;" title="동까지 입력" maxlength="200" readonly="readonly" /><br />
					...
					<tr>
						...
						<td>
							<div><label for="companyName_c" class="displayInB w70">명칭</label>
								<input type="text" name="ct_corp_c" id="companyName_c" class="text" style="width:440px;" title="명칭" maxlength="15"/>
							</div>
							<div class="mgt10 mgb10"><label for="companyPlace_c" class="displayInB w70">소재지</label>
								<input type="text" name="ct_corpaddr_c" id="companyPlace_c" class="text" style="width:440px;" title="소재지" maxlength="15"/>
							</div>
							<div><label for="ceoName_c" class="displayInB w70">대표자성명</label>
								<input type="text" name="ct_corpname_c" id="ceoName_c" class="text" style="width:440px;" title="대표자성명" maxlength="15"/>
							</div>
						</td>
					</tr>
					</tbody>
				...
				<!-- 신고대상 선택 -->
				<h4 class="title_dot_blue">피신고자(신고대상 선택)</h4>
				<table class="write mgb25" summary="성명, 직업(소속), 연락처, 주소, 법인,단체등의 경우 명칭, 소재지, 대표자성명 입력 테이블">
					<caption>부정청탁을 한 자 또는 금품등을 제공한 자</caption>
					<colgroup>
						<col style="width:18%;"/>
					...
					<tr>
						<th scope="row">연락처</th>
						<td>
							<input type="text" class="text" style="width:68px;" name="ct_tel1_c" title="연락처 첫번째자리" maxlength="3"/><span class="txt_dash vAlignM">-</span>
							<input type="text" class="text" style="width:68px;" name="ct_tel2_c" title="연락처 중간자리" maxlength="4"/><span class="txt_dash vAlignM">-</span>
							<input type="text" class="text" style="width:68px;" name="ct_tel3_c" title="연락처 마지막 자리" maxlength="4"/>
						</td>
					</tr>
					<tr>
						<th scope="row">주소</th>
				...
				<h4 class="title_dot_blue">법 위반행위 내용</h4>
				<table class="write mgb25" summary="일시, 장소, 내용, 신고취지 및 이유 입력 테이블">
					...
					<tr>
						...
						<td>
							<textarea style="width:508px; min-height:60px;" name="ct_content" title="내용입력" onclick="this.value='';"></textarea>
							<br / >(금품 등 수수의 경우 그 종류 및 가액)
						</td>
					</tr>
					<tr>
