...
<form name="pbform" method="post" action="shingo_find_psword_proc.jsp">
	<!-- 400*330 -->
	<div id="popUpWinHeight" class="wrapPopup">
		...
		<div class="innerBox">
			...
			<table class="write mgb10" summary="이름, 연락처로 구성된 표">
				...
				<tr>
					<th scope="row">이 름</th>
					<td><input type="text" name="name" class="text w100p" title="이름 입력" /></td>
				</tr>
				<tr>
					...
					<td>
						...
						<input type="text" maxlength="3" name="sh_han_1" class="text" style="width:70px;" title="전화번호 앞자리 입력" /><span class="txt_dash vAlignM">-</span><input type="text" maxlength="4" name="sh_han_2" class="text" style="width:70px;" title="전화번호 중간자리 입력" /><span class="txt_dash vAlignM">-</span><input type="text" maxlength="4" name="sh_han_3"  class="text" style="width:70px;" title="전화번호 끝자리 입력" />
					</td>
				</tr>
			</table>
		</div>
