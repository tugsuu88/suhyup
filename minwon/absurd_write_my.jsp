...
<!--
	...
	function ZipSearch(){
		...
		winurl = '../minwon/find_addr.jsp?return1=pbform.sh_post_1&amp;return2=pbform.sh_post_2&amp;return3=pbform.sh_address_1';
...
<form name="pbform" method="post" action="../minwon/absurd_proc_my.jsp">
                ...
                <td id="content">
                  ...
                  <table cellspacing="0" class="writeTable">
                    ...
                    <tr>
                      ...
                      <th class="essential"><span>&nbsp;&nbsp;&nbsp;&nbsp비밀번호</span></th>
