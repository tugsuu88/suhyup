...
<%
		...
		if(telephone.equals("휴대폰")){
			...
			WhereCondition = " where name = '"+name+"' and tel = '"+tel+"' and parcode = 4";	

		}else if(telephone.equals("전화번호")){

			WhereCondition = " where name = '"+name+"' and tel1 = '"+tel+"' and parcode = 4";	
...
<!--
	...
	function goView(mid){
		...
		d.action = "../minwon/corruption_view_my.jsp";
