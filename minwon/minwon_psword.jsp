...
<form name="pbform" method="post" enctype="multipart/form-data" action="minwon_psword_proc.jsp">
	<!-- 400*330 -->
	<div id="popUpWinHeight" class="wrapPopup">
		<h1 class="dpNone">수협</h1>
		<h2><span>비밀번호 찾기</span></h2>
		<div class="innerBox">
			<p class="mgb25">* 민원신청 시, 기재되었던 항목을 정확하게 기재하여 주세요.</p>
			<table class="write mgb10" summary="비밀번호 찾기">
				...
				<tr>
					...
					<td>
						...
						<input type="text" maxlength="3" name="sh_han_1" class="text" style="width:70px;" title="전화번호 앞자리" /><span class="txt_dash vAlignM">-</span><input type="text" maxlength="4" name="sh_han_2" class="text" style="width:70px;" title="전화번호 중간자리" /><span class="txt_dash vAlignM">-</span><input type="text" maxlength="4" name="sh_han_3"  class="text" style="width:70px;" title="전화번호 마지막자리" />
					</td>
				</tr>
			</table>
		</div>
