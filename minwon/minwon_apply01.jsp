...
<%
	...
	String sReturnUrl = "https://www.suhyup.co.kr/member/checkplus_success.jsp"; // 성공시 이동될 URL
	String sErrorUrl = "https://www.suhyup.co.kr/member/checkplus_fail.jsp"; // 실패시 이동될 URL
	
	//로컬
	//String sReturnUrl = "http://localhost:8080/member/checkplus_success.jsp"; // 성공시 이동될 URL
...
<script type="text/javascript">	//약관 동의 여부 체크	/* 실서버 올릴때 주석해제 */
	...
	function GoReg() {
		// 191119 웹 취약점 수정 : 실명인증 체크(기존 주석 처리된것 풀음)
...
<body id="minwon01">
	...
	<div id="ContentLayer">
		...
		<form name="pbform" method="post" action="">
			...
			<input type="hidden" name="sh_cata" value="없음" />
			...
			<div id="primaryContent">
				...
				<div class="pdl20 pdr30">
					...
					<dl class="box_line03 mgb20 mgl15" tabindex="0">
						...
						<dd>제공하신 개인정보는 신속하고 공정한 민원상담 · 처리(본인식별, 민원 사실관계 확인 및 민원처리결과
							통지 등)를 위한 용도로 수집 · 이용됩니다.</dd>
						<dt>수집하려는 개인정보의 항목</dt>
						<dd>성명, 생년월일, 주소, 전화(핸드폰)번호, 이메일 주소, 본인거래정보, 민원내용 등</dd>
						<dt>개인정보의 보유 및 이용기간</dt>
						<dd>위 개인정보는 수집 · 이용에 관한 동의일로부터 처리 종료일까지 민원사무처리를 위하여 보유 ·
							이용되며, 민원 종결 후에는 기타 법령 상 의무이행 및 소비자보호 업무수행을 위해 보유 · 이용됩니다.</dd>
						<dt>동의를 거부할 권리 및 동의 거부에 따른 불이익</dt>
						<dd>귀하께서 개인정보의 수집 · 이용 동의에 거부할 권리가 있으나, 위 정보는 본인 식별 및 민원에 대한
							사실관계 확인에 필수적인 정보로 수집 · 이용에 동의하셔야만 민원처리가 가능합니다.</dd>
					</dl>
					<div class="mgb50 pdl25">
						<input type="checkbox" class="checkbox mgr5" id="agree1"
							name="agree" value="ok" /><label for="agree1">위에 내용을 충분히
							인지하고 개인정보 수집 · 이용에 동의합니다.</label>
					</div>

					<h4 class="title_arrow_green01 mgb15">개인정보의 제3자(해당법인)제공 동의서</h4>
					<dl class="box_line03 mgb20 mgl15" tabindex="0">
						<dt>개인정보를 제공받는 자</dt>
						<dd>민원의 대상이 되는 수협중앙회(지사무소 포함), 회원조합, 자회사, 수협은행</dd>
						...
						<dd>해당법인은 민원(분쟁조정)사무의 처리 외의 목적으로 개인정보를 이용할 수 없으며 위 개인정보는 관계법령
							등의 규정에 의하여 기록 · 보존되고 기간이 경과할 경우 「개인정보보호법」등에서 정하는 바에 따라 파기됩니다.</dd>
						<dt>동의를 거부할 권리 및 동의 거부에 따른 불이익</dt>
						<dd>귀하께서 개인정보의 해당법인 제공에 동의하지 않을 수 있으나, 미동의로 본인 식별 및 민원에 대한
							사실관계 확인이 어려울 경우 민원처리가 불가능할 수 있습니다.</dd>
					</dl>
					<div class="mgb65 pdl25">
						<input type="checkbox" class="checkbox mgr5" id="agree2"
							value="ok" /><label for="agree2">위 내용을 충분히 인지하고 개인정보
							제3자(해당법인) 제공에 동의합니다.</label>
					</div>

					<p class="mgb10 mgl20">민원 결과 조회 확인시 꼭 필요한 사항으로 *표시가 되어있는 항목은
						반드시 정확하게 입력해 주세요</p>
					<div class="mgl15">
						<table class="write" summary="민원 신청을 위한 이름, 생년월일, 주소, 전화번호, 휴대폰, 이메일, 비밀번호, 민원대상, 회신방식 등록 입력폼">
							...
							<tr>
								<th scope="row"> <label for="name"><span class="txt_request">*</span>이름 </label></th>
								<td>
						 	<input type="text" name="name" class="text" style="width: 198px;" readonly="readonly" id="name" /> 
						 		<!-- <a href="#none" class="btn_blue_s01 mgl10" title="새창열림"> <span>실명인증</span></a><p class="displayInB mgl5">( 이름은 실명으로 공백없이 입력하세요.)</p> -->
 						 		<!--<a href="javascript:fnPopup();" class="btn_blue_s01 mgl10" title="새창열림"> <span>실명인증</span></a><p class="displayInB mgl5">( 이름은 실명으로 공백없이 입력하세요.)</p> 20201124 안내문구 수정-->
								<a href="javascript:fnPopup();" class="btn_blue_s01 mgl10" title="새창열림"> <span>실명인증</span></a><p class="displayInB mgl5">( 실명인증을 진행해주세요.)</p>
							</td>
							</tr>
							<tr>
								<th scope="row"><span class="txt_request">*</span>생년월일</th>
								<td>
								<label for="Year" class="tts">생년월일 년도</label>
								<select name="Year" class="mgr10" id="Year">
										...
										%>
										<option value="<%=yyyy%>"><%=yyyy%>년
										</option>
										<%
											}
										%>
								</select> 
								<label for="Month" class="tts">생년월일 월</label>
								...
								<label for="Day" class="tts">생년월일 일</label>
							...
							<tr>
								...
								<label for="sh_email_2" class="tts">이메일 주소 도메인 직접입력</label>
									<input type="text" name="sh_email_2" id="sh_email_2" value="" class="text" style="width: 148px;" />
								<label for="sh_email_3" class="tts">이메일주소 도메인 선택</label>
							...
							<tr>
								<th scope="row">
								<label for="psword" class=""><span class="txt_request">*</span>비밀번호</label></th>
							...
							<tr>
								...
								<td>
									<ul>
										<li class="mgb25"><span class="displayInB w70">법인구분:</span> 
											<!-- 
											2016.11.25 : sh_center 갑의 크기가 너무 큼 : 컬럼 크기값 수정해야함 
											2017.03.23 : sh_center(bupin) 명에서 코드로 변경. 1:수협중앙회-회원조합-자회사, 2:수협은행
											-->
											<input type="radio" name="sh_center" value="1" class="radio mgr5" id="complaint1" />
										    <label for="complaint1">수협중앙회-자회사</label>
											<input type="radio" name="sh_center" value="3" class="radio mgr5" id="complaint3" />
											<label for="complaint3">회원조합</label>
											<input type="radio" name="sh_center" value="2" class="radio mgr5 mgl10" id="complaint2" />
											<label for="complaint2">수협은행</label>
										</li>
										<li>
								<label for="self_text"><span class="displayInB w70">대상영업점</span></label>
											<input type="text" name="self_text" id="self_text" size="30" maxlength="15" value="글자수 15자리까지" onfocus="this.value=''"onblur="if(this.value =='') this.value='글자수 15자리까지';"
											class="text mgr5" style="width: 198px;"/>(직접입력)
										</li>
									</ul>
								</td>
							</tr>
							...
							<tr>
								<th scope="row">
								<label for="sh_reply_type" class=""><span class="txt_request">*</span>회신방식</label></th>
						...
						<p class="pdl23 mgt18">
							<span class="txt_request mgr5">*</span>으로 표시된 부분은 필수 입력사항
						</p>
					</div>
					<div class="btnR mgt30">
						<a href="javascript:GoReg();" class="btn_blue_arrowB01 w150"><span>민원신청</span></a><a
							href="javascript:pbform.reset();" class="btn_green_arrowB01 w150"><span>다시입력</span></a>
					</div>
				</div>
			</div>
			<!-- //contents -->
