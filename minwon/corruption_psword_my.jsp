...
<form name="pbform" method="post" action="../minwon/corruption_list_my.jsp">
                        ...
                        <table width="96%" border="0" cellspacing="0" cellpadding="0" height="45">
                          ...
                          <tr> 
                            ...
                            <td align="center" bgcolor="F9F9F9"><font color="323232"><b>비밀번호</b></font> 
							  ...
							  <a href="javascript:;" onClick="MM_openBrWindow('../minwon/corruption_find_psword_my.jsp','','width=360,height=260')"><img src="../pub_img/btminwon_searchpass.gif" width="85" height="20" align="absmiddle" border="0" title="비밀번호찾기버튼" /></a>
