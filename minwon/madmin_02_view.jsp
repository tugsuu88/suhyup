      ...
      <table width="945" border="0" cellspacing="0" cellpadding="0" background="img/title_bg.gif">
        <tr>
          ...
          <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="60" class="adminsub_subject" style="padding-left:25;">부서별 민원접수현황입니다</td>
              </tr>
            </table>
          </td>
        </tr>
  ...
  <tr>
    <td style="padding:0 0 10 10 ;">
      ...
      <table width="965" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="30"><img src="img/result.gif" align="absmiddle"> 민원내역
            <span class="result_text">상세보기</span></td>
          <td height="30" align="right" width="60"><a href="#"><img src="img/btn_print.gif" width="55" height="21" onClick="MM_openBrWindow('minwon_03_print.jsp?thididx=<%=thididx%>&bupin=<%=bupin%>&yongup=<%=yongup%>','','width=638,height=630')" border="0" alt="출력"></a></td>
          <td height="30" align="right" width="60"><a href="madmin_02.jsp?PAGE=<%=PAGE %>"><img src="img/btn_list.gif" width="55" height="21" border="0" alt="목록"></a></td>
        </tr>
        <tr>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="read_outline" height="100%">
                    <tr>
                      <td height="30" style="padding-left:10;" class="table_bg_title">민원접수 정보&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;첨부파일
					    ...
					    <%}else{%>
						<a href="javascript:DownloadPopup('<%=mid%>');"><img src="img/file_icon.gif" border="0" align="absmiddle"></a>
						<% } %></td>
                    </tr>
                    <tr>
                      <td valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td><%=name %> <a href="#" onClick="MM_openBrWindow('minwon_03_popup.jsp?thididx=<%=thididx%>&birthdate=<%=birthdate%>','','width=500,height=290')">[<u>상세정보
                              보기</u>]</a></td>
                          </tr>
                          <tr>
                            <td colspan="2" height="1" bgcolor="#d9e8f3"></td>
...
<td>
      ...
      <table width="945" border="0" cellspacing="0" cellpadding="0" class="table_outline">
		...
		<tr>
		<td width="90" class="bluesky">
		<input type="radio" name="min_gubun" value="일반민원" <%if(minwon_gubun.equals("일반민원")) out.print("checked"); %>>
                  일반민원 </td>
		<td width="80" class="bluesky">
		<input type="radio" name="min_gubun" value="단순질의"<%if(minwon_gubun.equals("단순질의")) out.print("checked"); %>>
                  단순질의</td>
		</tr>
		</table>
		</td>
      ...
      <table width="945" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td align="right"><a href="javascript:goReply(<%=thididx %>);"><img src="img/btn_reply.gif" width="55" height="21" alt="답변" border="0"></a></td>
		  <%} %>
        </tr>
      </table>
      <br>
