...
<!--
	...
	function goDel(){
		...
		if (confirm("삭제하시겠습니까?")) {
			...
			f.action = "corruption_del_proc.jsp";
	...
	function goCode(){
		...
		if (confirm("철회하시겠습니까?")) {
			...
			f.action = "corruption_code_proc.jsp";
	...
	<div id="ContentLayer">
		...
		<div id="primaryContent">
			...
			<div class="btnR mgt30">
				...
				<a class="btn_dGray_b01 mgl10" href="javascript:goCode();"><span>민원조회</span></a>
			</div>
		</div>
		<!-- //contents -->
	</div>
