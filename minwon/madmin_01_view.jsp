...
<%
	...
	String SelectCondition = " minwon_gubun,category,subject,name,buse_name,content,answer,result,status,junbuseo,reply_type,fname,mobile,bupin,yongup,birthdate,";
	SelectCondition += "to_char(creation_date, 'YYYY-MM-DD') AS creation_date, ";
	SelectCondition += "to_char(answer_date, 'YYYY-MM-DD') AS answer_date, to_char(abandon_date, 'YYYY-MM-DD') AS abandon_date ";
	...
	if (!finance_buseo.equals("all") && answer.equals("") && status.equals("신청")) {
		...
		try {
			...
			String sql = (("감사실".equals(finance_buseo) || "감사부".equals(finance_buseo))?"update sh_minwon set status='접수' where mid=?":"update sh_minwon set status='처리중' where mid=?");
...
function goReply(mid){
	...
	if(isstr){
		...
		********************************************위너다임 작업 끝 2008.03.13******************************************************/
		pbform.action="madmin_01_view_ok.jsp";
		pbform.submit();
	}
}
function send(){
	...
	if(confirm("이첩하시겠습니까?")){
		pbform.action="madmin_01_send_ok.jsp";
		pbform.submit();
	}
}
function receive(){
	if(confirm("반송하시겠습니까?")){
		pbform.action="madmin_01_receive_ok.jsp";
		pbform.submit();
	}
}
...
<form method=post name="pbform" action="" style="margin: 0px;">
				...
				<table width="945" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td height="60" class="adminsub_subject" style="padding-left: 25;">민원접수현황입니다</td>
								</tr>
							</table>
						</td>
					</tr>
				...
				<table width="965" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td height="30" align="right" width="60">
							<a href="#">
								<img src="img/btn_print.gif" width="55" height="21" onClick="MM_openBrWindow('minwon_03_print2.jsp?thididx=<%=thididx%>&bupin=<%=bupin%>&yongup=<%=yongup%>','','width=638,height=630')" border="0" alt="출력">
							</a>
						</td>
						<td height="30" align="right" width="60">
							<a href="madmin_01.jsp?PAGE=<%=PAGE%>"><img src="img/btn_list.gif" width="55" height="21" border="0" alt="목록"></a>
						</td>
					</tr>
					<tr>
		...
		<tr>
			<td style="padding: 10 0 0 25;">
								...
								<tr height="30">
									<td align="center" class="board_bg_title" valign="top"
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0"
											...
											<tr>
												<td style="padding: 20 20 20 20;">● 법인구분 : <%=bupin%><br />
													● 대상영업점 : <%=yongup%><br />
												<br /> <%=content%>
												</td>
											</tr>
									...
									<td class="board_bg_title" width="295" valign="top" align="right">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" class="read_outline" height="100%">
											<tr>
												<td height="30" style="padding-left: 10;" class="table_bg_title">민원접수 정보&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;첨부파일
												<%
													if (fname != null || !fname.equals("")) {
												%>
													<a href="javascript:DownloadPopup('<%=mid%>');">
														<img src="img/file_icon.gif" border="0">
													</a> 
												<%
													}
												%>
												...
												<td valign="top">
													<table width="100%" border="0" cellspacing="0"
														...
														<tr>
															...
															<td><%=name%> 
																<a href="#" onClick="MM_openBrWindow('minwon_03_popup.jsp?thididx=<%=thididx%>&birthdate=<%=birthdate%>','','width=500,height=290')">[<u>상세정보 보기</u>]</a>
															</td>
														</tr>
														<tr>
															<td colspan="2" height="1" bgcolor="#d9e8f3"></td>
														...
														<tr>
															...
															<%
																if (buse_name.equals("감사실")) {
															%>
															<td>
																<!-- 글내용이 감사실이면서 로그인한 사용자가 감사실인 사람,답변내용이 없는 경우 이첩 기능-->
																<%
																	if (finance_buseo.equals("감사실") && answer.equals("") && !status.equals("철회완료")) {
																%>
																<select name="buseo">
															...
															</select> <a href="javascript:send();"><img src="img/btn_transfer.gif" align="absmiddle" alt="이첩" border="0"></a>
															<!-- 글내용이 감사실이면서 로그인한 사용자가 감사실인 사람,답변내용이 있는 경우 소관부서 이름이 나타남-->
																<%
																	} else {
																%> 
																	<%=buse_name%> 
															...
															<!-- 글내용이 금융소비자보호단일 경우,감사실 또는 금융소비자보호단권한만이 볼수있는것 -->
															<%
																} else if (buse_name.equals("금융소비자보호부")) {
															%>
															<td>
																<!-- 글내용이 금융소비자보호단이면서 로그인한 사용자가 금융소비자보호단인 경우,답변내용이 없는 경우 감사실로 반송및 타부서로 이첩가능 -->
																<%
															...
															<br>
																...
																<a href="javascript:receive();"> 
																	<img src="img/btn_sendback.gif" align="absmiddle" border="0" alt="반송"></a> <input type="hidden" name="buseo_to" value="<%="감사실"%>"> 
															...
															<!-- 글내용이 감사실,금융소비자보호단이 아닌 경우,감사실,금융소비자보호부,동일한 부서만이 볼수있는것 -->
															<%
																} else {
															%>
															<!-- 로그인한 사람이 금융소비자보호단일 경우 소관부서 이름이 나타남-->
															<%
															...
															<%
																if (content.equals("")) {
															%>
															<!-- 글내용이 금융소비자보호단에 속한 경우-->
															<%
																if (junbuseo.equals("Y")) {
															%>
															<td>금융소비자보호단으로 <a href="javascript:receive();">
															<img src="img/btn_sendback.gif" align="absmiddle" border="0" alt="반송"></a></td>
															<input type="hidden" name="buseo_to" value="<%="금융소비자보호부"%>">
															<!-- 글내용이 감사실에 속한 경우-->
															<%
																} else {
															%>
															<td>감사실로 <a href="javascript:receive();">
															...
															%>
															<input type="hidden" name="buseo_from" value="<%=buse_name%>">
															<%
																//20080617 수정 끝
															%>
														</tr>
				...
				<table width="945" border="0" cellspacing="0" cellpadding="0" class="table_outline">
					...
					<tr>
						...
						<td style="padding-left: 25;" class="board_bg_contents" colspan="3">
							<textarea name="answer" cols="115" rows="8" wrap="physical"><%=answer%></textarea>
						</td>
					</tr>
					<tr>
						<td colspan="4" height="1" bgcolor="ffffff"></td>
					...
					<tr>
						...
						<td style="padding-left: 25;" class="board_bg_contents"
							...
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="90" class="bluesky"><input type="radio" name="min_gubun" value="일반민원" <%if (minwon_gubun.equals("일반민원")) out.print("checked");%>>일반민원</td>
									<td width="80" class="bluesky"><input type="radio" name="min_gubun" value="단순질의" <%if (minwon_gubun.equals("단순질의"))	out.print("checked");%>> 단순질의</td>
								</tr>
							</table>
						</td>
					</tr>
										...
										<table border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="150" class="black">
													<input type="radio" name="result" value="조치/시정" <%if (result.equals("조치/시정")) out.print("checked");%>>조치/시정
												</td>
												<td>&nbsp;</td>
												<td class="black" width="150">
													<input type="radio" name="result" value="절차안내" <%if (result.equals("절차안내"))	out.print("checked");%>>절차안내
												</td>
												<td>&nbsp;</td>
												<td class="black" width="150">
													<input type="radio" name="result" value="합의/조정" <%if (result.equals("합의/조정")) out.print("checked");%>>합의/조정
												</td>
												<td>&nbsp;</td>
												<td class="black">
													<input type="radio" name="result" value="설득이해" <%if (result.equals("설득이해")) out.print("checked");%>>설득이해
												</td>
											</tr>
										</table>
									</td>
								...
								<tr>
									...
									<td>
										<table border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="150" class="black">
													<input type="radio" name="result" value="법령/제도상불능" <%if (result.equals("법령/제도상불능")) out.print("checked");%>>법령/제도상불능
												</td>
												<td>&nbsp;</td>
												<td width="150" class="black">
													<input type="radio" name="result" value="내용불합리" <%if (result.equals("내용불합리")) out.print("checked");%>>내용불합리
												</td>
												<td>&nbsp;</td>
												<td width="150" class="black">
													<input type="radio" name="result" value="재정" <%if (result.equals("재정")) out.print("checked");%>> 재정
												</td>
												<td>&nbsp;</td>
												<td class="black">
													<input type="radio" name="result" value="사실상이" <%if (result.equals("사실상이"))	out.print("checked");%>> 사실상이
												</td>
											</tr>
										</table>
									</td>
								...
								<tr>
									...
									<td>
										<table border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="150" class="black">
													<input type="radio" name="result" value="익명주소무" <%if (result.equals("익명주소무")) out.print("checked");%>>익명주소무
												</td>
												<td>&nbsp;</td>
												<td width="150" class="black">
													<input type="radio" name="result" value="사적분쟁" <%if (result.equals("사적분쟁")) out.print("checked");%>>사적분쟁
												</td>
												<td>&nbsp;</td>
												<td width="150" class="black">
													<input type="radio" name="result" value="소송/수사" <%if (result.equals("소송/수사")) out.print("checked");%>>소송/수사
												</td>
												<td>&nbsp;</td>
												<td class="black">
													<input type="radio" name="result" value="불문(민원아님)" <%if (result.equals("불문(민원아님)")) out.print("checked");%>>불문(민원아님)
												</td>
											</tr>
										</table>
									</td>
								...
								<tr>
									...
									<td>
										<table border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="150" class="black">
													<input type="radio" name="result" value="건의/검토" <%if (result.equals("건의/검토")) out.print("checked");%>>건의/검토
												</td>
											</tr>
										</table>
									</td>
				...
				<table width="945" border="0" cellspacing="0" cellpadding="0">
					...
					<%
						} else if(finance_buseo.equals(buse_name) && !status.equals("철회완료")){
					%>
						<td align="right">
							<a href="javascript:goReply(<%=thididx %>);">
								<img src="img/btn_reply.gif" width="55" height="21" alt="답변" border="0">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td style="padding-left: 25;">
				...
				<span class="txt_title">부서간 이첩내역 이력관리</span>
			</td>
		</tr>
		<tr>
			<td style="padding: 10 0 0 25;">
	...
	<input type="hidden" name="mid" value="<%=mid %>"> <input
		...
		type="hidden" name="mobile" value="<%=mobile%>">
</form>
