...
<table width="300" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><img src="images/download_top.gif" alt="梅何颇老历厘" width="300" height="50" /></td>
					...
					<tr> 
          				...
          				<td align="left">
	          				<a href="../minwon/download.jsp?mid=<%=mid%>&file_no=<%=(String)h.get("SH_FILENO")%>">
	          					<img src="images/file_icon.gif" alt="颇老历厘" border="0" align="absmiddle" />&nbsp;<%=(String)h.get("FNAME")%>
	          				</a>
          				</td>
  ...
  <tr> 
    ...
    <td bgcolor="dfe9f4" height="30" align="right" style="padding-right:10px;"><a href="#" onClick="javascript:window.close();" style="cursor:pointer" ><img src="images/download_close.gif" alt="芒摧扁" border="0" /></a></td>
