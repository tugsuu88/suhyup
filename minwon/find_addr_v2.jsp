...
<form name="pbform" method="post" action="find_addr_v2.jsp">
					...
					<table class="listZipcode" summary="우편번호 검색 결과의 우편번호, 주소">
						...
						<tbody>
							...
							<tr>
								...
								<td class="pdl10"><a href='javascript:send_code("<%=zipcode%>","<%=addr1%>")'><%=addr%></a></td>
							</tr>
							<%
									}
							%>
			...
			<div class="innerBox">
				...
				<table class="writeZipcode mgb20" summary="주소의 시 도, 시 군 구, 동,읍,면,리 으로 우편번호 찾기">
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" class="text" style="width:168px;" title="동,읍,면,리명" name="SW_all" onkeypress="javascript:if(event.keyCode==13){EnterDown(event)}" /><a href="#" class="btn_blue_s01 mgl10"><span>검색</span></a>
						</td>
					</tr>
				</table>
