...
<head>
	<title>글쓰기 &gt; 예산낭비신고센터 &gt; 신고센터 &gt; 고객지원 &gt; 수협</title>
...
<form name="pbform" method="post" action="budget_proc.jsp">
			...
			<div class="pdl20 pdr20">
				<div class="mgl15">
					...
					<tr>
						<th scope="row">이메일</th>
						<td>
							<input type="text" class="text" style="width:98px;" title="이메일주소 앞자리" name="sh_email_1" onBlur="checkInput(this)" value="" />
							...
							<select class="mgl5" title="이메일주소 도메인 선택" name="sh_email_3" onChange="mail_change()">
