...
<%
	...
	try
	{
		...
		//out.print("TotalRecordCount : " + WhereCondition + "<br><br>");
		///////////////////////////////////////////////////////////////////////////
%>
...
<!--
	...
	function goDetailView(thid,PAGE){
		pbform.thid.value=thid;
		pbform.PAGE.value=PAGE;
		pbform.action = "finance_detail.jsp";
		pbform.submit();
	}
    ...
    <td style="padding:0 0 10 10 ;">
      ...
      <table width="960" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td height="30" align="right"><a href="excel/fin_excel.jsp?cmd=<%=cmd%>&KEY=<%=KEY%>&FIELD=<%=FIELD%>&startday=<%=startday%>&endday=<%=endday%>&status=<%=status%>&buse_name=<%=buse_name%>&result=<%=result%>"><img src="img/btn_excel.gif" width="66" height="21" border="0" alt="엑셀"></a></td>
        </tr>
        <tr>
      ...
      <table width="945" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center">
			...
			<%=FrontDbUtil.PrintPage(Integer.toString(PAGE), TotalRecordCount, DefaultListRecord, DefaultPageBlock, "finance.jsp?KEY="+KEY+"&cmd=" + cmd + "&FIELD=" + FIELD + "&startday=" + startday + "&endday=" + endday + "&status=" + status + "&buse_name=" + buse_name + "&PAGE=","<img src=img/board_prev.gif width=13 height=13 align=absmiddle border=0>","<img src=img/board_next.gif width=13 height=13 align=absmiddle border=0>")%>
			<% } %>
          </td>
        </tr>
      </table>
