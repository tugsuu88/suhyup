...
<head>
	<title>글쓰기 &gt; 면세유류 부정유통 신고 &gt; 신고센터 &gt; 고객지원 &gt; 수협</title>
...
<input type="hidden" name="vDiscrNo" value="<%=vDiscrNo%>">
	...
	<div id="ContentLayer">
		...
		<div id="primaryContent">
			<p class="indicate"><span class="shHome">수협</span><span>고객지원</span><span>신고센터</span>면세유류 부정유통 신고</p>
			<h3>면세유류 부정유통 신고</h3>
				...
				<div class="mgl15">
					...
					<tr>
						...
						<td>
							...
							<input type="text" class="text" style="width:98px;" title="이메일도메인 직접입력" name="sh_email_2" value="" />
							<select class="mgl5" title="이메일도메인 선택" name="sh_email_3" onChange="mail_change()">
					...
					<tr>
						...
						<td>
							<input type="password" class="text" style="width:198px;" title="비밀번호" name="psword" value="" /><p class="displayInB mgl5">(게시물을 수정 또는 삭제할 때 필요합니다.)</p>
						</td>
					</tr>
					</table>
