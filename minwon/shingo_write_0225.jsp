...
<head>
	<title>글쓰기 &gt; 금융사고 제보 &gt; 금융사고/금융부조리 &gt; 신고 신고센터 &gt; 고객서비스 &gt; 수협</title>
...
<input type="hidden" name="vDiscrNo" value="<%=vDiscrNo%>">
		...
		<div id="primaryContent">
			<p class="indicate"><span class="shHome">수협</span><span>고객서비스</span><span>신고센터</span>금융사고/금융부조리 신고</p>
			<h3>금융사고/금융부조리 신고</h3>
			<div class="pdl20 pdr20">
				...
				<div class="mgl15">
					...
					<tr>
						...
						<td>
							<input type="text" maxlength="3" name="sh_tel_1" onKeyUp="return autoTab(this, 3, event);" value="" class="text" style="width:68px;" title="휴대폰 앞자리" />
							<span class="txt_dash vAlignM">-</span>
							<input type="text" maxlength="4" name="sh_tel_2" onKeyUp="return autoTab(this, 4, event);" value="" class="text" style="width:68px;" title="휴대폰 중간번호" />
							<span class="txt_dash vAlignM">-</span>
							<input type="text" maxlength="4" name="sh_tel_3" onKeyUp="return autoTab(this, 4, event);" value="" class="text" style="width:68px;" title="휴대폰 뒷자리" />
						</td>
					</tr>
					<tr>
						<th scope="row">주소</th>
					...
					<tr>
						...
						<td>
							<input type="text" maxlength="3" name="sh_tele_1" onKeyUp="return autoTab(this, 3, event);" value="" class="text" style="width:68px;" title="전화번호 앞자리" />
							<span class="txt_dash vAlignM">-</span>
							<input type="text" maxlength="4" name="sh_tele_2" onKeyUp="return autoTab(this, 4, event);" value="" class="text" style="width:68px;" title="전화번호 중간자리" />
							<span class="txt_dash vAlignM">-</span>
							<input type="text" maxlength="4" name="sh_tele_3" onKeyUp="return autoTab(this, 4, event);" value="" class="text" style="width:68px;" title="전화번호 뒷자리" />
						</td>
					</tr>
					<tr>
