...
<%
	...
	try {	
		...
		sql += " mid,name,zipcode,addr,addr2,phone,email,passwd,category,mailing,subject,content,";      //테이블 필드

		sql += " answer,rejection,status,fname,faq,buse,minwon_gubun,creation_date,hit,";

		sql += " buse_name,mobile,juminnum,answer_fname,result03,result02,result04,result01,result,sh_fileno,junbuseo";
