...
<form name="pbform" method="post" action="absurd_list.jsp">
					...
					<table class="write01" summary="">
						...
						<tr>
							...
							<td>
								...
								<a href="javascript:NewPopUp('absurd_find_psword.jsp','360','260');" class="btn_blue_s01 mgl10" title="새창열림"><span>비밀번호 찾기</span></a>
							</td>
						</tr>
					</table>
