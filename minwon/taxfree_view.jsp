...
<head>
	<title>면세유류 부정유통 신고 &gt; 신고센터 &gt; 고객지원 &gt; 수협</title>
...
<!--
	...
	function goCode(){
		...
		if (confirm("철회하시겠습니까?")) {
			...
			f.action = "taxfree_code_proc.jsp";
...
<input type="hidden" name="name" value="<%=xss_Check(name)%>" />

<input type="hidden" name="passwd" value="<%=passwd%>" />

<input type="hidden" name="sh_mid" value="<%=xss_Check(sh_mid)%>" />

<input type="hidden" name="tel" value="<%=xss_Check(tel)%>">

<INPUT TYPE="hidden" NAME="telephone" value="<%=xss_Check(telephone)%>" />
