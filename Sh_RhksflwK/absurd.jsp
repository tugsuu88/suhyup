...
if(!(finance_buseo.equals("감사실") || finance_buseo.equals("감사부")) &&  !finance_buseo.equals("금융소비자보호부") &&  !finance_buseo.equals("조합감사실")){
            ...
            <tr>
                ...
                <td>
                    <select name="buse_name">
                        ...
                        <option value="금융소비자보호부"
                        <%if(buse_name.equals("금융소비자보호부")) { %>selected<% } %>>금융소비자보호부</option>
                        <option value="디지털금융부"
