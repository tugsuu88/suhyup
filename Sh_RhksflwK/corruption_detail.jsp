...
<!--
	...
	function goView(thid,PAGE){
		pbform.action = "corruption_view.jsp";
		pbform.submit();
	}
  ...
  <tr> 
    <td style="padding:0 0 10 10 ;"> 
      ...
      <table width="965" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="30"><img src="img/result.gif" align="absmiddle"> 행동강령 신고 <span class="result_text">상세보기</span></td>
                      ...
                      <td valign="top"> 
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            ...
                            <td height="30" style="width:85px; padding-left:10;" class="bluesky">특수코드</td>
                            <td><%=publication%></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            ...
                            <td><%=name%> <a href="#" onClick="MM_openBrWindow('finan_popup.jsp?thididx=<%=thididx%>','','width=500,height=290')">[<u>상세정보 보기</u>]</a></td>
                          </tr>
                          <tr> 
                            <td colspan="2" height="1" bgcolor="#d9e8f3"></td>
                          </tr>
