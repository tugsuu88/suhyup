			...
			<td style="padding: 0 0 10 10;">
				...
				<table width="960" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td height="30" align="right"><a href="excel/admin_excel.jsp"><img
								...
								<tr>
									...
									<select name="sh_buseo" onChange="">
										<option value="">선택</option>
											...
											<option value="<%=sh_buseo_cd%>"><%=sh_buseo_nm%></option>
												<% } %>
											<% } %>
										</select>
									</td>
									...
									<td><input type="text" class="input01" size="15"
										name="sh_name" value=""></td>
									<td width="30">&nbsp;</td>
									<td width="40" class="bluesky">직위</td>
									<td><select name="sh_gicwe" onChange="">
									...
									<td><select name="sh_gicgub" onChange="">
									...
									<td>
										<table border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												...
												<td class="black"><input type="checkbox" name="sh_admin_buseo" value="Y"> 부서별 민원관리</td>																								
			...
			<td >
				<table border="0" cellspacing="0" cellpadding="0" class="tbl-list">
					<tr>
						...
						<td class="board_bg_title"  align="center">부서</td>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="search">
					<tr>
						...
						<td class="cols02"><b>부서조회</b>&nbsp;&nbsp;<input type="text"
