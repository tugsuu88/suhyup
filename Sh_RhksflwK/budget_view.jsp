...
<%@ include file="include/top_menu10.jsp" %>
	...
	function goReply(thid){
		...
		if(isstr){
			...
			********************************************위너다임 작업 끝 2008.03.13******************************************************/
			...
			pbform.action="budget_view_ok.jsp";
			pbform.submit();
		}
	}
	function send(){
		...
		if(confirm("이첩하시겠습니까?")){
			pbform.action="budget_send_ok.jsp";
			pbform.submit();
		}
	}
	function receive(){
		if(confirm("반송하시겠습니까?")){
			pbform.action="budget_receive_ok.jsp";
			pbform.submit();
		}
	}
</script>
        ...
        <tr>
          <td width="135">
            <table width="135" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="70" align="center" class="admin_subject">예산낭비 신고</td>
              </tr>
            </table>
          </td>
          <td width="5"></td>
  ...
  <tr>
    <td style="padding:0 0 10 10 ;">
      ...
      <table width="965" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="30"><img src="img/result.gif" align="absmiddle"> 예산낭비 신고
          ...
          <td height="30" align="right" width="60"><a href="budget.jsp?PAGE=<%=PAGE %>"><img src="img/btn_list.gif" width="55" height="21" border="0" alt="목록"></a></td>
        </tr>
        <tr>
