...
<%
	...
	try {
		...
		/* if(bupin.equals("1")){
			finance_buseo = "준법감시실(중앙회)";
			where_buseo = "where bupin = '1'";
		}else if(bupin.equals("2")){
			finance_buseo = "소비자보호실(금융소비자보호부)";
			where_buseo = "where bupin = '2'";
		}else if(bupin.equals("3")){
			finance_buseo = "준법감시실(조합)";
			where_buseo = "where bupin = '3'";
		} */
		...
		/* if (!(finance_buseo.equals("감사실") || finance_buseo.equals("감사부")) && !finance_buseo.equals("금융소비자보호부")
				&& !finance_buseo.equals("준법감시실(중앙회)")) {
		...
		out.println("<script>alert('WhereCondition : '" + WhereCondition+");</script>");
...
<form method=post name="pbform" id="pbform" action="">
	<div class="list-header">
		<table border="0" cellspacing="0" cellpadding="0">
		 ...
		 <input type="text" class="input01" size="10" name="temp" value="<%=temp%>">
			<tr>
	...
	<div class="tbl-wrap">
		...
		<!-- 민원접수현황 리스트 -->
				<div class="subtit"><img src="img/arrow.gif" width="13" height="16" align="absmiddle"> <span class="txt_title">민원접수현황*******</span></div>
