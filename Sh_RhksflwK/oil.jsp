...
<%
	...
	try
	{
		...
		if(!(finance_buseo.equals("감사실") || finance_buseo.equals("감사부")) &&  !finance_buseo.equals("금융소비자보호부") &&  !finance_buseo.equals("자재사업부")){
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td rowspan="2" class="admin_subject">면세유류<br>부정유통신고</td>
    ...
    <tr>
        ...
        <td colspan="4">
            ...
            <input type="text" class="input01" size="48" name="KEY" value="<%=KEY%>" style="width: 180px">
    ...
    <div class="tbl-wrap">
      ...
      <!-- // 검색결과 -->
      <div class="subtit"><img src="img/arrow.gif" width="13" height="16" align="absmiddle">면세유류 부정유통신고</div>
