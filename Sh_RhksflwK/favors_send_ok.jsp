...
<jsp:useBean id="AdminInfo" scope="request"
	class="board.admin.AdminInfo" />
...
<%
	...
	try{
		...
		if(sh_buseo_to.equals("금융소비자보호부")){
			sql="update sh_chungtak set buseo=?,code=?,junbuseo='Y' where thid=? and code<>'답변완료'";
		}
		else{
