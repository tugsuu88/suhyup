...
<%
	...
	{	      
		...
		System.out.println("minwon_gubun = " + minwon_gubun);
		...
		SelectCondition += "to_char(answer_date, 'YYYY-MM-DD AM HH24:MI:SS') AS answer_date, answer";
