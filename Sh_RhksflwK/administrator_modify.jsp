...
<%
	...
	try {
		...
		sql +=" sh_admin_result, sh_admin_upright, sh_admin_jebo, sh_admin_bujori, sh_admin_myunsei, sh_admin_corruption, sh_admin_favors, sh_buseo, sh_gicwe, sh_gicgub, sh_admin_sms";
                ...
                <td width="140">
                  ...
                  <select name="sh_buseo" onChange="">
                    <option value="buseo">선택</option>
						...
						<%if(sh_buseo.equals(sh_buseo_cd)){ %>
