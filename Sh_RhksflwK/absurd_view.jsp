<%@ page import="java.util.*, util.*,java.text.SimpleDateFormat,javax.sql.*, javax.naming.*,java.sql.*, Bean.Common.*" contentType="text/html;charset=euc-kr"%>
...
<%
	...
	if( ResultVector.size() > 0){
		for (int i=0; i < ResultVector.size(); i++){
			...
			junbuseo=(String)h.get("JUNBUSEO");						sh_file_name=(String)h.get("SH_FILE_NAME");						sh_fileno=(String)h.get("SH_FILENO");
		}
	}
	if(text1==null) text1="";
	if(result==null) result="";	
	if(abandon_date != null && !abandon_date.equals(""))		abandon_date = abandon_date.replaceAll("<", "&lt;").replaceAll(">", "&gt;");
	...
	if(!finance_buseo.equals("all") && text1.equals("") && code.equals("신청")){
		DataSource ds = null;
		...
		try{
			...
			if(finance_buseo.equals("감사실") || finance_buseo.equals("감사부")){
				sql="update sh_financetrouble set code='접수' where thid=?";
			}
			else{
				sql="update sh_financetrouble set code='처리중' where thid=?";
			}
...
<script language="javascript">
	function goReply(thid){
		...
		if(isstr){
			...
			pbform.action="absurd_view_ok.jsp";
			pbform.submit();
		}
	}
	function send(){
		...
		if(confirm("이첩하시겠습니까?")){
			pbform.action="absurd_send_ok.jsp";
			pbform.submit();
		}
	}
	function receive(){
		if(confirm("반송하시겠습니까?")){
			pbform.action="absurd_receive_ok.jsp";
			pbform.submit();
		}
	}		function DownloadPopup1(thid){		pbform.thid.value=thid;		var wint = (screen.height - 245) / 2;		var winl = (screen.width - 300) / 2;		winprops = 'height=245,width=300,top='+wint+',left='+winl+',status=no,scrollbars=no,resize=no'		winurl = 'include/file_popup2.jsp?thid='+thid;		win = window.open(winurl, "file_popup2", winprops)	}
</script>
<!-- 금융사고 제보 설명 -->
        ...
        <tr>
          <td width="135">
            <table width="135" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="70" align="center" class="admin_subject">금융부조리 신고</td>
              </tr>
            </table>
          </td>
          <td width="5"></td>
  ...
  <tr>
    <td style="padding:0 0 10 10 ;">
      ...
      <table width="965" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="30"><img src="img/result.gif" align="absmiddle"> 금융부조리 신고
            <span class="result_text">상세보기</span></td>
          ...
          <td height="30" align="right" width="60"><a href="absurd.jsp?PAGE=<%=PAGE %>"><img src="img/btn_list.gif" width="55" height="21" border="0" alt="목록"></a></td>
        </tr>
        <tr>
  ...
  <tr>
    <td style="padding:10 0 0 25;">
                ...
                <td colspan="3">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td align="right" style="padding-right:10;">처리상태 : <%=xss_Check(code) %></td>
                    </tr>
                  </table>
                </td>
              </tr>
              ...
              <tr height="30">
                <td align="center" class="board_bg_title" valign="top" width="650">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="read_outline">
                    <tr>
                      <td align="center" height="30" class="table_bg_title"><%=xss_Check(title) %></td>
                    </tr>
                    <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="javascript:send();"><img src="img/btn_transfer.gif" align="absmiddle" alt="이첩" border="0"></a>
                              <!-- 글내용이 감사실이면서 로그인한 사용자가 감사실인 사람,답변내용이 있는 경우 소관부서 이름이 나타남-->
                              <%}else{ %>
                              	<%=buseo %>
                              <%} %>
                            </td>
                            <!-- 글내용이 준법감시팀일 경우,감사실 또는 금융소비자보호단권한만이 볼수있는것 -->
                            <%}else if(buseo.equals("금융소비자보호부")){%>
                            <td>
                            	<!-- 글내용이 준법감시팀이면서 로그인한 사용자가 준법감시팀인 경우,답변내용이 없는 경우 감사실로 반송및 타부서로 이첩가능 -->
                            	<%if(finance_buseo.equals("금융소비자보호부") && text1.equals("") && !code.equals("철회완료")){ %>
		                        ...
		                        <a href="javascript:send();"><img src="img/btn_transfer.gif" align="absmiddle" alt="이첩" border="0"></a>
		                        <br><br>
                              	감사실로 <a href="javascript:receive();"><img src="img/btn_sendback.gif" align="absmiddle" border="0" alt="반송" ></a>

                              	<input type="hidden" name="buseo_to" value="<%="감사실" %>">
		                        <!-- 글내용이 준법감시팀이면서 로그인한 사용자가 준법감시팀 또는 감사실일 경우,답변내용이 있는 경우 소관부서 이름이 나타남 -->
		                        <%}else{%>
		                        	<%if(junbuseo.equals("")){%>
		                        		<%=buseo %>
		                        	<%}else{%>
                            ...
                            <!-- 글내용이 감사실,금융소비자보호단이 아닌 경우,감사실,준법감시팀,동일한 부서만이 볼수있는것 -->
                            <%}else{ %>
                            	<!-- 로그인한 사람이 금융소비자보호단일 경우 소관부서 이름이 나타남-->
                            	<%if(finance_buseo.equals("금융소비자보호부")){ %>
                            		<td><%=buseo %></td>
                            	<!-- 로그인한 사람이 감사실일 경우 소관부서 이름이 나타남-->
                            	<%}else if(finance_buseo.equals("감사실") || finance_buseo.equals("감사부")){ %>
                            		<td>
                            	...
                            	<%}else{ %>
                            		...
                            		<%if(text1.equals("")){%>
                            			<!-- 글내용이 준법감사실에 속한 경우-->
                            			<%if(junbuseo.equals("Y")){ %>
                           					<td> 금융소비자보호단으로 <a href="javascript:receive();"><img src="img/btn_sendback.gif" align="absmiddle" border="0" alt="반송" ></a></td>
                           					<input type="hidden" name="buseo_to" value="<%="금융소비자보호부" %>">
                           				<!-- 글내용이 감사실에 속한 경우-->
                           				<%}else{ %>
                           					<td> 감사실로 <a href="javascript:receive();"><img src="img/btn_sendback.gif" align="absmiddle" border="0" alt="반송" ></a></td>
                           					<input type="hidden" name="buseo_to" value="<%="감사실" %>">
                           				<%} %>
                           			<!-- 답변을 단 경우-->
                            		<%}else{ %>
                  ...
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="150" class="black">
                        <input type="radio" name="result" value="조치/시정" <%if(result.equals("조치/시정")) out.print("checked"); %>>
                        조치/시정</td>
                      <td>&nbsp;</td>
                      <td class="black" width="150">
                        <input type="radio" name="result" value="절차안내" <%if(result.equals("절차안내")) out.print("checked"); %>>
                        절차안내</td>
                      <td>&nbsp;</td>
                      <td class="black" width="150">
                        <input type="radio" name="result" value="합의/조정" <%if(result.equals("합의/조정")) out.print("checked"); %>>
                        합의/조정</td>
                      <td>&nbsp;</td>
                      <td class="black">
                        <input type="radio" name="result" value="설득이해" <%if(result.equals("설득이해")) out.print("checked"); %>>
                        설득이해</td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                ...
                <td>
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="150" class="black">
                        <input type="radio" name="result" value="법령/제도상불능" <%if(result.equals("법령/제도상불능")) out.print("checked"); %>>
                        법령/제도상불능</td>
                      <td>&nbsp;</td>
                      <td width="150" class="black">
                        <input type="radio" name="result" value="내용불합리" <%if(result.equals("내용불합리")) out.print("checked"); %>>
                        내용불합리</td>
                      <td>&nbsp;</td>
                      <td width="150" class="black">
                        <input type="radio" name="result" value="재정" <%if(result.equals("재정")) out.print("checked"); %>>
                        재정</td>
                      <td>&nbsp;</td>
                      <td class="black">
                        <input type="radio" name="result" value="사실상이" <%if(result.equals("사실상이")) out.print("checked"); %>>
                        사실상이</td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                ...
                <td>
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="150" class="black">
                        <input type="radio" name="result" value="익명주소무" <%if(result.equals("익명주소무")) out.print("checked"); %>>
                        익명주소무</td>
                      <td>&nbsp;</td>
                      <td width="150" class="black">
                        <input type="radio" name="result" value="사적분쟁" <%if(result.equals("사적분쟁")) out.print("checked"); %>>
                        사적분쟁</td>
                      <td>&nbsp;</td>
                      <td width="150" class="black">
                        <input type="radio" name="result" value="소송/수사" <%if(result.equals("소송/수사")) out.print("checked"); %>>
                        소송/수사</td>
                      <td>&nbsp;</td>
                      <td class="black">
                        <input type="radio" name="result" value="불문(민원아님)" <%if(result.equals("불문(민원아님)")) out.print("checked"); %>>
                        불문(민원아님)</td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                ...
                <td>
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="150" class="black">
                        <input type="radio" name="result" value="건의/검토" <%if(result.equals("건의/검토")) out.print("checked"); %>>
                        건의/검토</td>
                    </tr>
                  </table>
                </td>
      ...
      <table width="945" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="right">
		  <%if(finance_buseo.equals(buseo) && !code.equals("철회완료")){ %>
          	<a href="javascript:goReply(<%=thididx %>);"><img src="img/btn_reply.gif" width="55" height="21" alt="답변" border="0"></a>
          <%} %>
        </tr>
      </table>
      <br>
