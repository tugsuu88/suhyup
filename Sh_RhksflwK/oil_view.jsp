...
<script language="javascript">
	...
	function send(){
		...
		if(confirm("이첩하시겠습니까?")){
			pbform.action="oil_send_ok.jsp";
			pbform.submit();
		}
	}
	function receive(){
		if(confirm("반송하시겠습니까?")){
			pbform.action="oil_receive_ok.jsp";
			pbform.submit();
		}
	}
</script>
        ...
        <tr>
          <td width="135">
            <table width="135" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="70" align="center" class="admin_subject">면세유류<br>부정유통신고</td>
              </tr>
            </table>
          </td>
          <td width="5"></td>
  ...
  <tr>
    <td style="padding:0 0 10 10 ;">
      ...
      <table width="965" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="30"><img src="img/result.gif" align="absmiddle">면세유류 부정유통신고
            <span class="result_text">상세보기</span></td>
          <td height="30" align="right" width="60"><a href="#"><img src="img/btn_print.gif" width="55" height="21" onClick="MM_openBrWindow('finance_print3.jsp?thididx=<%=thididx%>','','width=638,height=630')" border="0" alt="출력"></a></td>
          <td height="30" align="right" width="60"><a href="oil.jsp?PAGE=<%=PAGE %>"><img src="img/btn_list.gif" width="55" height="21" border="0" alt="목록"></a></td>
        </tr>
        <tr>
                      ...
                      <td valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <%-- <%if(buseo.equals("감사실") || buseo.equals("감사부")){%> --%>                            <%if(finance_buseo.equals("자재사업부")){%>
                            <td>

							<!-- 글내용이 감사실이면서 로그인한 사용자가 감사실인 사람,답변내용이 없는 경우 이첩 기능-->
				          	<%-- <%if((finance_buseo.equals("감사실") || finance_buseo.equals("감사부")) && finance_buseo.equals("자재사업부") && text1.equals("") && !code.equals("철회완료")){ %> --%>							<%if(finance_buseo.equals("자재사업부") && text1.equals("") && !code.equals("철회완료")){ %>
                            ...
                            <!-- 글내용이 준법감시팀일 경우,감사실 또는 준법감시팀권한만이 볼수있는것 -->
                            ...
                            <td>
		                        ...
		                        <a href="javascript:send();"><img src="img/btn_transfer.gif" align="absmiddle" alt="이첩" border="0"></a>
		                        <br><br>
                              	자재사업부로 <a href="javascript:receive();"><img src="img/btn_sendback.gif" align="absmiddle" border="0" alt="반송" ></a>

                              	<input type="hidden" name="buseo_to" value="<%="자재사업부" %>">
		                        <!-- 글내용이 준법감사실이면서 로그인한 사용자가 준법감시팀 또는 감사실일 경우,답변내용이 있는 경우 소관부서 이름이 나타남 -->
		                        <%}else{%>
		                        	<%if(junbuseo.equals("")){%>
		                        		<%=buseo %>
		                        	<%}else{%>
                            ...
                            <!-- 글내용이 감사실,준법감시팀 아닌 경우,감사실,준법감시팀,동일한 부서만이 볼수있는것 -->
                            <%}else{ %>
                            	...
                            	<%}else{ %>
                            		...
                            		<%if(text1.equals("")){%>
                            			...
                            			<%if(junbuseo.equals("Y")){ %>
                           				...
                           				<!-- 글내용이 감사실에 속한 경우-->
                           				<%}else{ %>
                           					<td> 자재사업부로 <a href="javascript:receive();"><img src="img/btn_sendback.gif" align="absmiddle" border="0" alt="반송" ></a></td>
                           					<input type="hidden" name="buseo_to" value="<%="자재사업부" %>">
                           				<%} %>
                           			<!-- 답변을 단 경우-->
                            		<%}else{ %>
