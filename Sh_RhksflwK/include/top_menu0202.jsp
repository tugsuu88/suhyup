      ...
      <table border="0" cellspacing="0" cellpadding="0">
	        <tr>
			  ...
			  <% if(sa_admin_minwonall.equals("Y") && sa_admin_buseo.equals("Y") && sa_admin_upright.equals("Y")) { %>
			  	...
			  	<a href="madmin_01.jsp">민원접수현황</a> ｜ <b>부서별 민원관리</b> ｜ <a href="admin_upright_list.jsp">청렴수협인상</a>  <% if(sa_admin_sms.equals("Y") ) { %> | <a href="center_minwon_admin_list.jsp">민원담당 SMS관리</a> <% } %>
			  ...
			  <% } else if(sa_admin_minwonall.equals("Y") && sa_admin_buseo.equals("Y") && sa_admin_upright.equals("")) {%>
				...
				<a href="madmin_01.jsp">민원접수현황</a> | <a href="madmin_02.jsp"><b>부서별 민원관리</b></a> <% if(sa_admin_sms.equals("Y") ) { %> | <a href="center_minwon_admin_list.jsp">민원담당 SMS관리</a> <% } %>	 				  		
			  
			  <% } else if(sa_admin_minwonall.equals("Y") && sa_admin_buseo.equals("") && sa_admin_upright.equals("Y")) {%>
			
				<a href="madmin_01.jsp">민원접수현황</a> | <a href="admin_upright_list.jsp">청렴수협인상</a> <% if(sa_admin_sms.equals("Y") ) { %> | <a href="center_minwon_admin_list.jsp">민원담당 SMS관리</a> <% } %>					  		
			 
			  <% } else if(sa_admin_minwonall.equals("") && sa_admin_buseo.equals("Y") && sa_admin_upright.equals("Y")) {%>
			
				<a href="madmin_02.jsp"><b>부서별 민원관리</b></a> | <a href="admin_upright_list.jsp">청렴수협인상</a> <% if(sa_admin_sms.equals("Y") ) { %> | <a href="center_minwon_admin_list.jsp">민원담당 SMS관리</a> <% } %>					  		
