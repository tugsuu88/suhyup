    ...
    <td bgcolor="#284e8f"> 
      <table cellspacing=0 cellpadding=0 border=0 height="35">
        <tr> 
          ...
          <td  align="center" width="135"><a href="administrator.jsp" class="menu_off">관리자관리</a></td>
          ...
          <td align="center" width="150"><a href="result.jsp"  class="menu_off">민원처리결과공시</a></td>
		  <td width="2" align="center"><img src="img/top_line.gif"></td>
		  <% } %>
          ...
          <td align="center" width="150"> 
            <table width="96%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td class="menu_on" background="img/top_m02.gif" align="center">신고물품 처리결과 공개</td>
