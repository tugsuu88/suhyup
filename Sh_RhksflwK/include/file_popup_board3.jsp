...
<%
	try {
		...
		String TableName2 = " sh_board_file3 ";
	   	String SelectCondition2 = " sh_no, file_no, file_name ";
		String WhereCondition2  = " where sh_no =  '" + sh_no + "'" ;
      ...
      <table width="280" border="0" cellspacing="0" cellpadding="0">
		...
		%>
					<tr> 
          				...
          				<td align="left"><a href="download_board3.jsp?sh_no=<%=sh_no%>&file_no=<%=(String)h.get("FILE_NO")%>"><img src="../img/file_icon.gif" border="0" align="absmiddle">&nbsp;<font size="2"><%=(String)h.get("FILE_NAME")%></font></a></td>
        			</tr>
        			<tr bgcolor="ebebeb"> 
