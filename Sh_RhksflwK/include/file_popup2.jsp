<%@ page import="java.util.*, java.text.*, util.*, Bean.Common.*" contentType="text/html;charset=euc-kr"%>
...
<%
	try {
	    ...
	    if (thid == null || thid.equals("")) thid = "";
	    
	
		String TableName2 = " sh_financetrouble ";
	   	String SelectCondition2 = " thid, sh_fileno, fname, sh_file_name ";
		String WhereCondition2  = " where thid =  '" + thid + "'" ;
		String OrderCondition2  = " ORDER BY thid ";
      ...
      <table width="280" border="0" cellspacing="0" cellpadding="0">
		...
		%>
					<tr> 
          				...
          				<td align="left">
	          				<a href="../include/download2.jsp?thid=<%=thid%>&file_no=<%=xss_Check((String)h.get("SH_FILENO"))%>">
		          				<img src="../img/file_icon.gif" border="0" align="absmiddle">&nbsp;
		          					<font size="2"><%=xss_Check((String)h.get("SH_FILE_NAME"))%>
		          				</font>
	          				</a>
          				</td>
        			</tr>
