    ...
    <td bgcolor="#284e8f"> 
      <table cellspacing=0 cellpadding=0 border=0 height="35">
        <tr> 
          ...
          <td align="center" width="120"><a href="madmin_01.jsp" class="menu_off">민원관리</a></td>
		  <td width="2" align="center"><img src="img/top_line.gif"></td>
		  <% }else if(sa_admin_minwonall.equals("Y")) { %>
          <td align="center" width="120"><a href="madmin_01.jsp" class="menu_off">민원관리</a></td>
		  <td width="2" align="center"><img src="img/top_line.gif"></td>
		  <% }else if(sa_admin_buseo.equals("Y")) { %>
          <td align="center" width="120"><a href="madmin_02.jsp" class="menu_off">민원관리</a></td>
		  <td width="2" align="center"><img src="img/top_line.gif"></td>
		  <% } %>
          ...
          <td align="center" width="170" class="menu_off">
            <table width="96%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td class="menu_on" background="img/top_m02.gif" align="center">면세유류 부정유통 신고</td>
