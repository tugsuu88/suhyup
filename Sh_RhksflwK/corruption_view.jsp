...
<%@ include file="include/top_menu09.jsp" %>
...
<script language="javascript">
	function goReply(thid){
		...
		if(isstr){
			...
			pbform.action="corruption_view_ok.jsp";
			pbform.submit();
		}
	}
	function send(){
		...
		if(confirm("이첩하시겠습니까?")){
			pbform.action="corruption_send_ok.jsp";
			pbform.submit();
		}
	}
	function receive(){
		if(confirm("반송하시겠습니까?")){
			pbform.action="corruption_receive_ok.jsp";
			pbform.submit();
		}
	}
</script>
        ...
        <tr>
          <td width="135">
            <table width="135" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="70" align="center" class="admin_subject">행동강령 신고</td>
              </tr>
            </table>
          </td>
          <td width="5"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="padding:0 0 10 10 ;">
      ...
      <table width="965" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="30"><img src="img/result.gif" align="absmiddle"> 행동강령 신고
          ...
          <td height="30" align="right" width="60"><a href="corruption.jsp?PAGE=<%=PAGE %>"><img src="img/btn_list.gif" width="55" height="21" border="0" alt="목록"></a></td>
        </tr>
        <tr>
  ...
  <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td>
                            	...
                            	<%if(finance_buseo.equals("준법감시실") && text1.equals("") && !code.equals("철회완료")){ %>
                            	<select name="buseo">			                    	<option value="">선택</option>
	                                ...
	                                <option value="고객자산관리부(펀드)" >고객자산관리부(펀드)</option>
	...
	<!--                            <option value="안전관리실" >안전관리실</option>   -->
                            ...
                            <td>
                            	<!-- 글내용이 준법감시팀이면서 로그인한 사용자가 금융소비자보호단인 경우,답변내용이 없는 경우 감사실로 반송및 타부서로 이첩가능 -->
		                        ...
		                        <a href="javascript:send();"><img src="img/btn_transfer.gif" align="absmiddle" alt="이첩" border="0"></a>
		                        <br><br>
                              	준법감시실로 <a href="javascript:receive();"><img src="img/btn_sendback.gif" align="absmiddle" border="0" alt="반송" ></a>

                              	<input type="hidden" name="buseo_to" value="<%="준법감시실" %>">
                            ...
                            <!-- 글내용이 감사실,준법감시팀이 아닌 경우,감사실,준법감시팀,동일한 부서만이 볼수있는것 -->
                            <%}else{ %>
                            	...
                            	<%}else{ %>
                            		...
                            		<%if(text1.equals("")){%>
                            			...
                            			<%if(junbuseo.equals("Y")){ %>
                           				...
                           				<!-- 글내용이 감사실에 속한 경우-->
                           				<%}else{ %>
                           					<td> 준법감시실로 <a href="javascript:receive();"><img src="img/btn_sendback.gif" align="absmiddle" border="0" alt="반송" ></a></td>
                           					<input type="hidden" name="buseo_to" value="<%="준법감시실" %>">
                           				<%} %>
                           			<!-- 답변을 단 경우-->
                            		<%}else{ %>
