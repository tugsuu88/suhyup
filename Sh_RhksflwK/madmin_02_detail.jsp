...
<%
	...
	String SelectCondition = " minwon_gubun,status,subject,name,content,answer,buse_name,answer_fname,result,category,bupin,yongup,reply_type,birthdate, sh_fileno, sh_file_name,";
...
// 			System.out.println("bupin1 = " + bupin);
// 			bupinNm = (("1".equals(bupin))?"수협중앙회-회원조합-자회사":"수협은행");
// 			System.out.println("bupin2 = " + bupin);						yongup=(String)h.get("YONGUP");			reply_type = (String)h.get("REPLY_TYPE");
  ...
  <tr> 
    <td style="padding:0 0 10 10 ;"> 
      ...
      <table width="965" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="30"><img src="img/result.gif" align="absmiddle"> 민원내역 <span class="result_text">상세보기</span></td>
		  <%if(finance_buseo.equals(buse_name)){%>
          <td height="30" align="right"><a href="javascript:goView();"><img src="img/btn_adjust.gif" width="55" height="21" alt="수정" border="0"></a></td>
		  <%} %>
          <td height="30" align="right" width="60"><a href="#"><img src="img/btn_print.gif" width="55" height="21" onClick="MM_openBrWindow('minwon_03_print.jsp?thididx=<%=thididx%>&yongup=<%=yongup%>','','width=638,height=630')" border="0" alt="출력"></a></td>
              ...
              <tr height="30"> 
                <td align="center" class="board_bg_title" valign="top" width="650"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="read_outline">
                    ...
                    <tr> 
                      <td style="padding:20 20 20 20;">						● 법인구분 : <%=(String) session.getAttribute("buseName") %><br />												● 대상영업점 : <%=yongup %><br /><br />
                      <%=content%>
                      </td>
                    </tr>
                  </table>
                        ...
                        <colgroup>
                          ...
                          <tr> 
                            ...
                            <%}else{ %>
                            	<td> <%=buse_name %></td>
                            <%} %>
                            	<input type="hidden" name="buse_name" value="<%=buse_name %>">
                          </tr>
                        </table>
                      </td>
                    </tr>
            ...
            <table cellpadding="0" cellspacing="0" border="0">
              ...
              <tr height="30"> 
                ...
                <td class="board_bg_title" width="295" valign="top" align="right"> 
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="read_outline" height="100%">
                    <tr> 
                      <td height="30" style="padding-left:10;" class="table_bg_title">민원접수/처리 결과 내역</td>
                    </tr>
                    <tr> 
                      <td valign="top"> 
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
