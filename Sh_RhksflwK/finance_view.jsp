  ...
  <tr>
    <td style="padding:0 0 10 10 ;">
      ...
      <table width="965" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="30"><img src="img/result.gif" align="absmiddle"> 금융사고 제보
            <span class="result_text">상세보기</span></td>
          <td height="30" align="right" width="60"><a href="#"><img src="img/btn_print.gif" width="55" height="21" onClick="MM_openBrWindow('finance_print2.jsp?thididx=<%=thididx%>','','width=638,height=630')" border="0" alt="출력"></a></td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td>
                            	...
                            	<%if(finance_buseo.equals("감사실") && text1.equals("") && !code.equals("철회완료")){ %>
                            	<select name="buseo">
                            ...
                            <td>
		                        ...
		                        <!-- 글내용이 준법감시팀이면서 로그인한 사용자가 준법감사실 또는 감사실일 경우,답변내용이 있는 경우 소관부서 이름이 나타남 -->
		                        <%}else{%>
		                        	<%if(junbuseo.equals("")){%>
		                        		<%=buseo %>
		                        	<%}else{%>
